    ...
    <div className="w-full">
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          formData.append("ownerFullName", values.ownerDetails.fullName);
          formData.append("ownerEmail", values.ownerDetails.email);
          formData.append("ownerPhone", values.ownerDetails.phone);

          // Append restaurant address details
          formData.append(
            "restaurantAddress",
            values.restaurantAddressDetails.address
          );
          formData.append(
            "restaurantArea",
            values.restaurantAddressDetails.area
          );
          formData.append(
            "restaurantCity",
            values.restaurantAddressDetails.city
          );

          // Append the selected image (ensure the image is in File/Blob format)
          if (selectedImage) {
            formData.append("restaurantImage", selectedImage);
          }
        }}
      >
